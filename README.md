...
Captures d'écran : [pictures/1-ingestion/](pictures/1-ingestion/)
...
Captures d'écran : [pictures/2-azure_ai/](pictures/2-azure_ai/)
...
Captures d'écran : [pictures/3-power_bi/](pictures/3-power_bi/)
...
├── pictures/
│   ├── 1-ingestion/                # Captures d'écran Azure Storage & téléversement
│   ├── 2-azure_ai/                 # Captures d'écran Azure OpenAI & Language
│   └── 3-power_bi/                 # Captures d'écran du dashboard Power BI
├── requirements.txt
